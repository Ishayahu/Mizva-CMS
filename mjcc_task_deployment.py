...
# Словарь паролей
env.passwords={'ishayahu@192.168.1.25':'aA111111','ishayahu@192.168.1.214':'aA111111'}
env.shell='/bin/csh -c'
# папка с fab файлом
deployment_folder = '/usr/home/ishayahu/docsrv/scripts/Vil-mezuza/'
# папка с исходниками в локальном git репозитории
source_folder = '/usr/home/ishayahu/docsrv/scripts/Vil-mezuza/'
# Сервера для выполнения задачи
servers= {'test':['ishayahu@192.168.1.214',],
    ...
    if ans == 'Д':
	    ...
	    with cd(project):
                ...
                if type_of_server=='test':
                    make_and_send_settings(host='192.168.1.253',port='5432',email_host='smtp.gmail.com',email_port='25',email_user=e_mail,email_password=e_psswd,where_to_place='~/tasks/tasks/')
